  ...
  <div class="container-fluid p-0">
      ...
      <ul class="navbar-nav mx-auto">
        <li class="nav-item dropdown dropdown-slide">
          <a class="nav-link" href="index.php"  data-toggle="dropdown">Home
            <span>/</span>
          </a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item dropdown dropdown-slide">
          <a class="nav-link" href="gallery.php" data-toggle="dropdown">Gallery<span>/</span></a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="sponsors.php">Sponsors<span>/</span></a>
        </li>
        <li class="nav-item dropdown dropdown-slide">
          <a class="nav-link" href="news-single.php"  data-toggle="dropdown">News
            <span>/</span>
          </a>
          </li>
        <li class="nav-item">
